...
export class MESSAGE_ANALYST_CONFIG {
  static REGEX_QUANTITY =  /[0-9]+[瓶|盒|箱|件|个|只|罐|条|袋|支|管|盒|瓶]?$/g;
  ...
  static ORDER_PATTERNS: TextPattern[] = [{
    ...
    countSymbol:    {minimalLength: 0,maximalLength: 0,lowerLength: 0,higherLength: 0, weight: 1,},
    keywords: "省;市;县;区;镇;街;社区;村;组;路;小区;号;大厦;座;中心;幢;单元;楼;栋",
    keywordsWeight: 100,
    required: false,
    priority: 1,
    multiple: false,
    ...
    countNumber:    {minimalLength: 0,maximalLength: 0,lowerLength: 0,higherLength: 0, weight: 1,},
    countChinese:   {minimalLength: 0,maximalLength: 40,lowerLength: 2,higherLength: 20, weight: 100,},
    countSymbol:    {minimalLength: 0,maximalLength: 0,lowerLength: 0,higherLength: 0, weight: 1,},
    keywords: null,
    keywordsWeight: 10,
    required: false,
    ...
    keywords: /((\d{11})|^((\d{7,8})|(\d{4}|\d{3})-(\d{7,8})|(\d{4}|\d{3})-(\d{7,8})-(\d{4}|\d{3}|\d{2}|\d{1})|(\d{7,8})-(\d{4}|\d{3}|\d{2}|\d{1}))$)/g,
    keywordsWeight: 0,
    required: false,
    priority: 1,
    multiple: true,
    ...
    countChinese:   {minimalLength: 0,maximalLength: 2,lowerLength: 0,higherLength: 2, weight: 1,},
    countSymbol:    {minimalLength: 0,maximalLength: 0,lowerLength: 0,higherLength: 0, weight: 1,},
    keywords: /[0-9]+[瓶|盒|箱|件|个|只|罐|条|袋|支|管|盒|瓶]$/g,
    keywordsWeight: 100,
    required: false,
    priority: 1,
    multiple: true,
  },{
    category: MessageSectionCategory.CommodityNameAndQuantity,
    prefix: /^((商品)+|(产品)+)(是)*/g,
    prefixWeight: 1,
    countEnglish:   {minimalLength: 0,maximalLength: 40,lowerLength: 2,higherLength: 20, weight: 100,},
    countNumber:    {minimalLength: 1,maximalLength: 3,lowerLength: 1,higherLength: 2, weight: 1,},
    countChinese:   {minimalLength: 4,maximalLength: 42,lowerLength: 2,higherLength: 22, weight: 100,},
    countSymbol:    {minimalLength: 0,maximalLength: 0,lowerLength: 0,higherLength: 0, weight: 1,},
    keywords: /[^0-9]{2,}[0-9]+[瓶|盒|箱|件|个|只|罐|条|袋|支|管|盒|瓶]?$/g,
    keywordsWeight: 100,
    required: false,
    priority: 1,
    multiple: true,
